...
class ThemesClass {
  ...
  static final ThemeData WomanDarkTheme = ThemeData(
      brightness: Brightness.dark,
      primaryColor: WomanFirstColor,
      secondaryHeaderColor: WomanSecondColor,
      focusColor: Colors.white,
      scaffoldBackgroundColor: Colors.black,
      iconTheme: IconThemeData(color: Colors.white, size: 30),
      disabledColor: Colors.white24,
      cardColor: WomanFirstColor,
      textTheme: TextTheme(
        titleLarge: TextStyle(
            color: Colors.white, fontSize: 25, fontWeight: FontWeight.bold),
        titleMedium: TextStyle(
  ...
  static final ThemeData WomanLightTheme = ThemeData(
    brightness: Brightness.light,
    primaryColor: WomanSecondColor,
    secondaryHeaderColor: WomanFirstColor,
    focusColor: Colors.black,
    scaffoldBackgroundColor: Colors.black,
    iconTheme: IconThemeData(color: Colors.black, size: 30),
    cardColor: kFirstColor,
