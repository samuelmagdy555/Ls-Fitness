          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    navigateToToFinish(context,  WelcomeView());
                  },
                  child: Container(
                    height: height*.05,
                    width: width*.3,
