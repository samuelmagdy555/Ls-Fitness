...
class IllnessAndInjury extends StatefulWidget {
  @override
  _IllnessAndInjuryState createState() => _IllnessAndInjuryState();
}

class _IllnessAndInjuryState extends State<IllnessAndInjury>
  ...
  void initState() {
    ...
    Timer(Duration(seconds: 5), () {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => TrainingDays()),
      );
    });
  }
