...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    bodyDimensions = json['bodyDimensions'] != null
        ? List.from(json['bodyDimensions']).map((e) => BodyDimensions.fromJson(e)).toList()
        : [];
    fitnessLevel = json['fitnessLevel'] ?? '';
    mainGoal = json['mainGoal'] ?? '';
    allergicSubstances = json['allergicSubstances'] ?? '';
    injuries = json['injuries'] != null ? List.castFrom<dynamic, String>(json['injuries']) : [];
    exercisePreference = json['exercisePreference'] ?? '';
    trainingNumberDays = json['trainingNumberDays'] ?? '';
    trainingDays = json['trainingDays'] != null ? List.castFrom<dynamic, String>(json['trainingDays']) : [];
    diets = json['diets'] ?? '';
