...
class SupplementsTap extends StatelessWidget {
  ...
  builder: (context, state) {
    return VitaminScreenCubit.get(context).supplementModel == null
      ...
      itemCount: VitaminScreenCubit.get(context).supplementModel!.data.length,
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: Image(
                        image: AssetImage(VitaminScreenCubit.get(context).supplementModel!.data[index].image),
                        width: width * .4,
                        height: height * .09,
                        fit: BoxFit.cover,
                      ),
                    ...
                    Column(
                      children: [
                        Text(
                          VitaminScreenCubit.get(context).supplementModel!.data[index].title,
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: width * .065,
