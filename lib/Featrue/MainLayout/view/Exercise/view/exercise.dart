...
class _WorkoutScreenState extends State<WorkoutScreen>
  ...
  void dispose() {
    ...
    controller.dispose();
    ExerciseCubit.get(context).exercisesModel =null;
    super.dispose();
  }
                      ...
                      if (ExerciseCubit.get(context).filter[index] == index) {
                        ...
                        showMenu(
                          ...
                          if (selected != null) {
                            ...
                            ExerciseCubit.get(context)
                                .generateFilterMap(page: 1, controller: controller);
          ...
          BlocConsumer<ExerciseCubit, ExerciseState>(
            ...
            builder: (context, state) {
              if (ExerciseCubit.get(context)
                      ...
                      ?.paginationResult
                      .numberOfPages ==
                  0 || ExerciseCubit.get(context).exercisesModel == null) {
                return Center(
                  child: Text(
                    '',
              ...
              return NumberPaginator(
                  ...
                  onPageChange: (int index) {
                    ...
                    ExerciseCubit.get(context)
                        .generateFilterMap(page: index+1, controller:controller);
                  });
            },
          ),
          Expanded(
