...
class _CreatineTabState extends State<CreatineTab> with TickerProviderStateMixin {
  ...
  int _selectedValue = 1; // القيمة الافتراضية
            ...
            children: [
              ...
              CustomSlidingSegmentedControl<int>(
                ...
                onValueChanged: (int value) {
                  setState(() {
                    _selectedValue = value; // تحديث القيمة
              ...
              Expanded(
                ...
                Expanded(
                  child: ListView.builder(
                      itemCount: CreatineCubit.get(context).waterByLiter.length,
                              ...
                              SizedBox(
                                  ...
                                  child: TextButton(onPressed: ()async {
                                    ...
                                    if (pickedTime != null) {
                                      ...
                                      await Alarm.stop(
                                          CreatineCubit.get(context).waterByLiter[index].id);

                                      await Alarm.set(
                                          alarmSettings: AlarmSettings(
                                            id: CreatineCubit.get(context).waterByLiter[index].id,
                                            dateTime: selectedDateTime,
                                            assetAudioPath: 'assets/alarm.mp3',
                                            loopAudio: true,
                                            vibrate: true,
                                    ...
                                    CreatineCubit.get(context).waterByLiter[index].time,
                                  ...
                                  child: TextButton(onPressed: ()async {
                                    ...
                                    if (pickedTime != null) {
                                      ...
                                      CreatineCubit.get(context)
                                          .updateCreatineTime(index, formattedTime);
                                      await Alarm.stop(
                                          CreatineCubit.get(context).waterByCup[index].id);

                                      await Alarm.set(
                                          alarmSettings: AlarmSettings(
                                            id: CreatineCubit.get(context).waterByCup[index].id,
                                            dateTime: selectedDateTime,
                                            assetAudioPath: 'assets/alarm.mp3',
                                            loopAudio: true,
                                            vibrate: true,
                                    ...
                                    CreatineCubit.get(context).waterByCup[index].time,
                                    textAlign: TextAlign.end,
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: width * .045,
