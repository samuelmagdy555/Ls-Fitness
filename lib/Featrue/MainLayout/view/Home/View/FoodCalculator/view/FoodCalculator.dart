...
import 'package:lsfitness/Featrue/MainLayout/view/Home/View/FoodCalculator/view/FoodCalculatorDetails/view/FoodCalulatorDetails.dart';
import 'package:lsfitness/Featrue/MainLayout/view/Home/View/FoodCalculator/view/FoodCalculatorDetails/viewmodel/food_calculator_Details_cubit.dart';
...
import 'package:lsfitness/Featrue/MainLayout/view/Home/View/FoodCalculator/view_Model/food_calculator_cubit.dart';
...
class _FoodCalculatorState extends State<FoodCalculator> {
  ...
  void initState() {
    ...
    _paginatorController = NumberPaginatorController();
    context.read<FoodCalculatorCubit>().getFoodCalculator(mealCategory: widget.mealCategory, page: 1);
  }
          ...
          BlocConsumer<FoodCalculatorCubit, FoodCalculatorState>(
            ...
            builder: (context, state) {
              if (state is FoodCalculatorLoading) {
                return const Center(child: CircularProgressIndicator(color: kSecondColor));
                  ...
                  child: Column(
                    children: [
                      NumberPaginator(
                        ...
                        numberPages: foodCalculatorModel.paginationResult.numberOfPages,
                        onPageChange: (int pageIndex) {
                          context.read<FoodCalculatorCubit>().getFoodCalculator(
                              mealCategory: widget.mealCategory, page: pageIndex + 1);
                        },
                      ),
                      Expanded(
