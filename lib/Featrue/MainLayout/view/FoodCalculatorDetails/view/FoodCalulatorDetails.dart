...
class _FoodCalculatorDetailsState extends State<FoodCalculatorDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<FoodCalculatorDetailsCubit, FoodCalculatorDetailsState>(
        ...
        builder: (context, state) {
            ...
            final calculationData = FoodCalculatorDetailsCubit.get(context).foodCalculatorDetails!.data.calculationData;
...
style: TextStyle(color: Colors.white),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          context.read<FoodCalculatorDetailsCubit>().fetchFoodCalculatorDetails(
                            mealId: widget.id,
                    ...
                    if (calculationData != null) ...[
                      _buildNutrientRow('Proteins', calculationData.protein , ),
